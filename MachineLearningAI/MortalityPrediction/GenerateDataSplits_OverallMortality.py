...
patients_train, patients_test = train_test_split(patients, test_size = 0.2, random_state = 6250)
...
mortality_train = patients_train[['SUBJECT_ID', 'EXPIRE_FLAG']]
mortality_train.columns = [['SUBJECT_ID', 'MORTALITY']]



mortality_test = patients_test[['SUBJECT_ID', 'EXPIRE_FLAG']]
mortality_test.columns = [['SUBJECT_ID', 'MORTALITY']]



mortality_validation = patients_validation[['SUBJECT_ID', 'EXPIRE_FLAG']]

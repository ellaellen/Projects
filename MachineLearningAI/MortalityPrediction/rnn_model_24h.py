...
PATH_TRAIN_SEQS = "../data/24hr_mortality/processed/mortality.seqs.train"
PATH_TRAIN_LABELS = "../data/24hr_mortality/processed/mortality.labels.train"
PATH_VALID_SEQS = "../data/24hr_mortality/processed/mortality.seqs.validation"
PATH_VALID_LABELS = "../data/24hr_mortality/processed/mortality.labels.validation"
PATH_TEST_SEQS = "../data/24hr_mortality/processed/mortality.seqs.test"
PATH_TEST_LABELS = "../data/24hr_mortality/processed/mortality.labels.test"
PATH_TEST_IDS = "../data/24hr_mortality/processed/mortality.ids.test"
PATH_OUTPUT = "../output24hr/mortality/"

if not os.path.exists('../output24hr/mortality'):
    os.mkdir('../output24hr')
    os.mkdir('../output24hr/mortality')    
else:    
    pass

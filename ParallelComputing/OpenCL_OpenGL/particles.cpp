...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System " };
...
Display( )
{
	...
	{
		char str[128];
		sprintf( str, "%e GigaParticles/Sec", (float)NUM_PARTICLES/ElapsedTime/1000000000. );
...
InitLists( )
{
	...
	glNewList( SphereList, GL_COMPILE );
		...
		glPushMatrix( );
			...
			glTranslatef( -100., -800., -3000. );
			glutWireSphere( 700., 100., 100. );

			glTranslatef( -1000., -2000., -0. );
			glutWireSphere( 800., 100., 100. );
		glPopMatrix( );
	glEndList( );

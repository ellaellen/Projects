...
<?php
    ...
    $query = "DELETE FROM gw_sales_details WHERE gw_sales_details.sid = '$sale' AND gw_sales_details.item_id IN (SELECT gw_products.product_id FROM gw_products WHERE gw_products.name = '$name') LIMIT 1 ";
    ...
    if(!$stmt->execute()){
        ...
        echo "Deleted " . $stmt->affected_rows . " rows to sales table.";
    }
